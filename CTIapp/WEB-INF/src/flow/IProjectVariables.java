...
public interface IProjectVariables {
	...
	public static final String COLLECTDIGITS = "collectdigits";
	public static final String SESSION = "session";
	public static final String UUIDATATOSEND = "UUIDATATOSEND";
	public static final String TRANSFERTOEXTN = "transfertoextn";
	...
	public static final String CHOICES_FIELD_CONFIDENCE = "confidence";
	public static final String CHOICES_FIELD_INPUTMODE = "inputmode";
	public static final String CHOICES_FIELD_INTERPRETATION = "interpretation";
	public static final String CHOICES_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String CHOICES_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String CHOICES_FIELD_UTTERANCE = "utterance";
	public static final String CHOICES_FIELD_VALUE = "value";
	...
	public static final String COLLECTDIGITS_FIELD_CONFIDENCE = "confidence";
	public static final String COLLECTDIGITS_FIELD_INPUTMODE = "inputmode";
	public static final String COLLECTDIGITS_FIELD_INTERPRETATION = "interpretation";
	public static final String COLLECTDIGITS_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String COLLECTDIGITS_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String COLLECTDIGITS_FIELD_UTTERANCE = "utterance";
	public static final String COLLECTDIGITS_FIELD_VALUE = "value";
	...
	public static final String TRANSFERTOEXTN_FIELD_ANI = "ani";
	public static final String TRANSFERTOEXTN_FIELD_CALLID = "callid";
	public static final String TRANSFERTOEXTN_FIELD_DNIS = "dnis";
	public static final String TRANSFERTOEXTN_FIELD_STATE = "state";
	public static final String TRANSFERTOEXTN_FIELD_STATIONEXTENSION = "stationextension";
	public static final String TRANSFERTOEXTN_FIELD_UCID = "ucid";
	public static final String TRANSFERTOEXTN_FIELD_UUI = "uui";
