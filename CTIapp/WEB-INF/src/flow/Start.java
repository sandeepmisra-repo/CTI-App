...
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2019-AUG-29  10:01:54 AM
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("collectdigits");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.CHOICES_FIELD_CONFIDENCE,
			IProjectVariables.CHOICES_FIELD_INPUTMODE,
			IProjectVariables.CHOICES_FIELD_INTERPRETATION,
			IProjectVariables.CHOICES_FIELD_NOINPUTCOUNT,
			IProjectVariables.CHOICES_FIELD_NOMATCHCOUNT,
			IProjectVariables.CHOICES_FIELD_UTTERANCE,
			IProjectVariables.CHOICES_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.CHOICES, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.COLLECTDIGITS_FIELD_CONFIDENCE,
			IProjectVariables.COLLECTDIGITS_FIELD_INPUTMODE,
			IProjectVariables.COLLECTDIGITS_FIELD_INTERPRETATION,
			IProjectVariables.COLLECTDIGITS_FIELD_NOINPUTCOUNT,
			IProjectVariables.COLLECTDIGITS_FIELD_NOMATCHCOUNT,
			IProjectVariables.COLLECTDIGITS_FIELD_UTTERANCE,
			IProjectVariables.COLLECTDIGITS_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.COLLECTDIGITS, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.UUIDATATOSEND, "This is the test", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.TRANSFERTOEXTN_FIELD_ANI,
			IProjectVariables.TRANSFERTOEXTN_FIELD_CALLID,
			IProjectVariables.TRANSFERTOEXTN_FIELD_DNIS,
			IProjectVariables.TRANSFERTOEXTN_FIELD_STATE,
			IProjectVariables.TRANSFERTOEXTN_FIELD_STATIONEXTENSION,
			IProjectVariables.TRANSFERTOEXTN_FIELD_UCID,
			IProjectVariables.TRANSFERTOEXTN_FIELD_UUI };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.TRANSFERTOEXTN, variableFields, null, session, false, false );
		session.putVariable(variable);
